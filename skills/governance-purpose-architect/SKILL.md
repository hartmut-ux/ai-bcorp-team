...
- Purpose **öffentlich kommunizieren** (Website, Jahresbericht)
- Sicherstellen, dass der Purpose über das B Corp Legal Requirement hinausgeht

**Gute Purpose Statements:**
- Spezifisch (nicht generisch "die Welt verbessern")
...
- **Stakeholder Engagement Mechanismus** aufbauen
...
**Compliance Criteria:**
- Grievance Procedure auf der Webseite veröffentlichen (in relevanten Sprachen)
- Klare Prozessschritte und Fristen definieren
- Schutz vor Vergeltung für Beschwerdesteller sicherstellen
- Regelmässige Kommunikation über den Lösungsprozess
- Hauptstakeholder über das Verfahren informieren
- Interessenkonflikte in der Entscheidungsfindung vermeiden

**Template-Struktur:**
1. Wer kann eine Beschwerde einreichen?
2. Welche Themen werden akzeptiert?
3. Wie wird eine Beschwerde eingereicht?
4. Welche Schritte folgen nach Einreichung?
5. Welche Fristen gelten?
6. Wie wird die Lösung kommuniziert?
...
- Verknüpfung mit GRI, ESRS, CDP wo relevant
- Öffentlich zugänglich auf der Webseite

## Outputs

- Purpose Statement (DE/EN, bereit für Statuten und Website)
- Stakeholder Map (visuell, mit Engagement-Kanälen)
- Double Materiality Matrix
- Grievance Procedure (webfähig, PDF und HTML)
- Board Reporting Template (Traktandenliste + KPIs)
- Impact Report Struktur (Gliederung + Datenanforderungen)
...
- Statutenanpassung nach OR Art. 620 ff. (AG) oder Art. 772 ff. (GmbH)
- nDSG-Konformität bei Stakeholder-Daten
- Schweizer Corporate Governance Best Practice (economiesuisse)
