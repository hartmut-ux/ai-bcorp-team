...
- Wertschöpfungskette analysieren (Upstream + Downstream)
- Wesentliche Umweltauswirkungen identifizieren:
...
- Massnahmen priorisieren (nach Schwere und Machbarkeit)
- Fortschritt jährlich dokumentieren

**Für Investmentunternehmen (ESC2.7):**
- Umweltauswirkungen von Investitionen bewerten
...
- Produktdesign für Kreislauf (Design for Disassembly)
- Verpackungsoptimierung
- Materialeffizienz steigern

**Circular Water Management:**
- Reduce → Reuse → Recycle → Restore → Recover
...
- **Deforestation-free** Compliance sicherstellen (EU Regulation 2023/1115):
  - Produkte ohne Abholzung nach 31.12.2020
  - Lieferkettennachweis
- **Biodiversitäts-Aktionsplan** erstellen
...
- Gemeinsame Ziele und Tracking
- Eskalation bei Nicht-Einhaltung

## Outputs

- Environmental Impact Report
- Circularity Action Plan
- Waste & Resource Audit
- Water Risk Assessment
- Biodiversity Impact Map
- Deforestation-free Compliance Report
- Supplier Environmental Scorecard
- Environmental Strategy (mit messbaren Zielen)

## Interoperabilität

- **GRI 301** (Materials), **302** (Energy), **303** (Water), **304** (Biodiversity), **306** (Waste)
