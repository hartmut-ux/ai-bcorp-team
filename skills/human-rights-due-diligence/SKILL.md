...
- Referenz auf internationale Standards (UNGP, ILO, International Bill of Human Rights)
- Genehmigung durch Highest Governing Body
- Veröffentlichung auf der Webseite
- Kommunikation an alle Mitarbeitenden und Geschäftspartner

**Die Policy muss enthalten:**
- Bekenntnis zu den Menschenrechten
- Scope (eigene Operationen + Wertschöpfungskette)
- Wie die Policy umgesetzt wird
...
2. Priorisierung nach **Schwere** (Ausmass, Scope, Unumkehrbarkeit)
3. Berücksichtigung der gesamten **Wertschöpfungskette**
4. Einbezug von **Affected Stakeholders** in die Analyse
5. **Strategie** zur Adressierung der Salient Issues erstellen

**Typische Salient Issues (branchenabhängig):**
- Arbeitsbedingungen in der Lieferkette
- Kinderarbeit / Zwangsarbeit
- Gesundheit und Sicherheit am Arbeitsplatz
- Recht auf Privatsphäre (Datenschutz)
- Landrechte und Indigenous Peoples
...
- Risiko-basierter Ansatz: Fokus auf Hochrisiko-Lieferanten
- Capacity Building bei Lieferanten
- Eskalationsmechanismus bei Verstössen

## Outputs

- Human Rights Policy (DE/EN, webfähig)
- Salient Issues Register (priorisiert nach Schwere)
- Human Rights Due Diligence Report
- Supplier Code of Conduct
- Supplier Assessment Template
- Remediation Log (Vorfälle, Massnahmen, Status)
- Investment Screening Report (für Investmentunternehmen)
...
- **ESRS S1–S4** (Own Workforce, Workers in Value Chain, Affected Communities, Consumers)
